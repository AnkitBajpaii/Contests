...
namespace Service.Tests
{
    ...
    *****/
    public class EncoderSpec : IClassFixture<EncoderSpec>
    {
        [Theory]        
        ...
        public void Encoder_HashesStringCorrectly(string toEncode, string expected)
        {
            ...
            stopWatch.Start();
            IEncodingRuleEngine encodingRuleEngine = new EncodingRuleEngine();
            string res = new EncoderProcessor(encodingRuleEngine).Encode(toEncode);
